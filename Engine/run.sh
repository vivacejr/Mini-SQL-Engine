...
python3 engine.py "Slect table1.B, table2.B from table1, table2 where A > 0 and table1.B = table2.B;"

python3 engine.py "Select table1.B, table2.B table1, table2 where A > 0 and table1.B = table2.B;"

python3 engine.py "Select"

python3 engine.py "Select table1.B, table2.B from table1, table2 where A > 0 and table1.B = table2.B"

python3 engine.py "Select table1.B, table2.B from table1, table2 where A > 0 xor table1.B = table2.B;"

python3 engine.py "Select table1.B, table2.B from table1, table2 where A > 0 and B = table2.B;"

python3 engine.py "Select table1.B, table2.B from table1, table2 wherre A > 0 and table1.B = table2.B;"

python3 engine.py "table1.B, table2.B from table1, table2 where A > 0 and table1.B = table2.B;"

python3 engine.py "from table1, table2 where A & 0 and table1.B = table2.B;"
